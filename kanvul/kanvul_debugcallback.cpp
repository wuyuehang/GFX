...
VKAPI_ATTR VkBool32 VKAPI_CALL kvDbgReportCallback(VkFlags msgFlags, VkDebugReportObjectTypeEXT objType,
...
public:
    ~KanVul() {
        ...
        _dbgDestroyDebugReportCallback(_inst, _dbg_report_cb, nullptr);
    ...
    void InitDBGCallback() {
        _dbgCreateDebugReportCallback = (PFN_vkCreateDebugReportCallbackEXT)vkGetInstanceProcAddr(_inst, "vkCreateDebugReportCallbackEXT");
        _dbgDestroyDebugReportCallback = (PFN_vkDestroyDebugReportCallbackEXT)vkGetInstanceProcAddr(_inst, "vkDestroyDebugReportCallbackEXT");
        ...
        dbgCallbackInfo.pfnCallback = kvDbgReportCallback;
        ...
        _dbgCreateDebugReportCallback(_inst, &dbgCallbackInfo, nullptr, &_dbg_report_cb);
    }
...
private:
    ...
    VkDebugReportCallbackEXT _dbg_report_cb;
    VkSurfaceKHR _surf;
